...
class ThirdIntroScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    return (
      <LinearGradient colors={["#FBFAF8", "#F0F0F0"]} style={styles.container}>
        <Image
          source={require("../../assets/image/img_intro03.png")}
        ...
        <Text style={styles.text_bold_intro}>
          Promo menarik hanya dari ponsel mu{" "}
        </Text>
        <Text style={styles.text_intro}>
          Dapatkan kejutan penawaran menarik dari Papandayan Cargo di ponsel
          kamu
        </Text>
      </LinearGradient>
    );
