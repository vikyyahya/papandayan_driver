...
class FormCollectorAddress extends Component {
  constructor(props) {
    super(props);
    this.state = {
      date: "",
  ...
  async submitForm() {
    ...
    if (this.state.isForm == true) {
      ...
      if (this.state.temporary == true) {
        await postData(BASE_URL + DEPTOR, params, this.state.token).then(
          (response) => {
        ...
        await saveData("COLLECTOR_ADDRESS", params);
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.text_header}>Formulir Alamat Penagihan</Text>
          </View>
...
export default FormCollectorAddress;
