...
class ReturnAddress extends Component {
  ...
  async goBack() {
    ...
    if (this.state.data_address.length == 0) {
      await saveData("SENDER_ADDRESS", null);
    }
    this.props.navigation.navigate("PickUp");
    console.log("goBack sender_address", this.state.selected_address);
    console.log("goBack sender_address", this.state.data_address.length);
  }
  goForm() {
    this.props.navigation.navigate("FormReturnAddress");
  }
  ...
  async actionCheck(data, index) {
    ...
    await saveData("SENDER_ADDRESS", this.state.selected_address);
    // this.goBack();
  }
  ...
  async deleteAddress(item) {
    ...
    await deleteData(
      BASE_URL + SENDER + "/" + this.state.idSelectedAddress,
      this.state.token
    ).then((response) => {
  ...
  actionEdit(data) {
    this.props.navigation.navigate("EditFormSenderAddress", { data: data });
  }
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.text_header}>Alamat Pengirim</Text>
        </View>
