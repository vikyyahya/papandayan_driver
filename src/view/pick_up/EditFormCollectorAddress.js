...
class EditFormCollectorAddress extends Component {
  constructor(props) {
    super(props);
    this.state = {
      date: "",
  ...
  async submitForm() {
    ...
    if (this.state.isForm == true) {
      ...
      if (this.state.temporary == true) {
        await putData(
          BASE_URL + "api/deptor/" + this.state.id,
          params,
          this.state.token
        ).then((response) => {
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.text_header}>
              Formulir Edit Alamat Penagihan
            </Text>
          </View>
...
export default EditFormCollectorAddress;
